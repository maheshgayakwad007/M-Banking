      ...
      <div style={styles.footerContainer}>
        ...
        <div style={styles.footerTop}>
          ...
          <div style={styles.footerSection}>
            <h3 style={styles.sectionTitle}>About ChainPay</h3>
            <p style={styles.sectionText}>
               ChainPay is a blockchain-powered digital payment platform designed to
               provide fast, secure, and transparent financial transactions. By using
                decentralized technology, ChainPay ensures enhanced security, reduced
              transaction costs, and greater trust between users.
            </p>
            <div style={styles.socialIcons}>
              <button style={styles.socialIcon} aria-label="Facebook">
              ...
              <button style={styles.socialIcon} aria-label="Twitter">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <button style={styles.socialIcon} aria-label="LinkedIn">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div style={styles.footerSection}>
            ...
            <ul style={styles.linkList}>
              ...
              <li style={styles.linkItem}>
                <Link to="/about" style={styles.footerLink}>About ChainPay</Link>
              </li>
              <li style={styles.linkItem}>
          ...
          <div style={styles.footerSection}>
            ...
            <ul style={styles.contactList}>
              ...
              <li style={styles.contactItem}>
                ...
                <span>info@ChainPay-portal.edu.in</span>
              </li>
              <li style={styles.contactItem}>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style={styles.contactIcon}>
        ...
        <div style={styles.footerBottom}>
          <p style={styles.copyrightText}>
            &copy; {new Date().getFullYear()} ChainPay Portal. All Rights Reserved.
          </p>
